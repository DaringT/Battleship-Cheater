...
class Battleship:
	...
	def grid_directions_to_bs_grid(self, dir_dict):
		...
		for ship_type, coordinates in dir_dict.items():
			Battleship.Add_Ships.add_ships(coordinates=coordinates, ship_type=ship_type)
		return self.battleship_grid
...
display_all_ships_heatmap = lambda output_file:DisplayGrid.make_heat_graft(
